# -*- coding: utf-8 -*-
"""Write the new parse_detail_text function to a separate temp file"""
import re

# Use raw string so \n stays as literal backslash+n, not real newlines
NEW_FUNC = r'''
...
with open(r'C:\Users\Ivy\.openclaw\workspace\Ad_Placement_Data_Crawler\facebook\_new_parse_func.py', 'w', encoding='utf-8') as f:
